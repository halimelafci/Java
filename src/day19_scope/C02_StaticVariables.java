...
public class C02_StaticVariables {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        staticMethod();  //static methoddakini bu sekilde cagırabilirken
        staticSayi=12;
        System.out.println(staticSayi); // 12
        C02_StaticVariables obje1=new C02_StaticVariables();  //static olmayan methodu objeyle cagırabiliriz
